...
class Usuario implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function addPostagem(Postagem $postagem): static
    {
        if (!$this->postagems->contains($postagem)) {
            $this->postagems->add($postagem);
    ...
    public function removePostagem(Postagem $postagem): static
    {
